...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ModelLog.id_zap'
        db.delete_column('testapp_modellog', 'id_zap')

        # Adding field 'ModelLog.target_instance'
        db.add_column('testapp_modellog', 'target_instance',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ModelLog.id_zap'
        db.add_column('testapp_modellog', 'id_zap',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'ModelLog.target_instance'
        db.delete_column('testapp_modellog', 'target_instance')
